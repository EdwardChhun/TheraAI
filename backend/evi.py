...
"""
# HACK: 
# Import the sound device so I can fix a problem with the loud environment
# change the microphone decible input to -1000000 when assistant is talking and turn back on when finished

# After "type: user_message" is seen, set the decible to -1000000
# When "type: assistant_end" is seen, set the decible back to normal
